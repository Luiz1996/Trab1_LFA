...
public class ConsoleView {
    ...
    public static int showMenu() {
        ...
        System.out.println("==  VALIDADOR DE AUTÔMATOS FINITOS DETERMINÍSTICOS ==");
        System.out.println("|    01) Inserir alfabeto                           |");
        System.out.println("|    02) Inserir estados                            |");
        System.out.println("|    03) Inserir estado inicial                     |");
        System.out.println("|    04) Inserir estado(s) final(is)                |");
        System.out.println("|    05) Inserir transição(ões)                     |");
        System.out.println("|    06) Imprimir autômato                          |");
        System.out.println("|    07) Resetar autômato                           |");
        System.out.println("|    08) Validar palavra                            |");
